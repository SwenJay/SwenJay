...
- 🎓 Software Engineering undergraduate at **Lanka Nippon BizTech Institute (LNBTI)** — 🏅 Dean's Award, 3 consecutive semesters, GPA above 3.8/4.0
- 💡 Focused on **backend engineering, REST API development, database systems, systems integration, and application architecture**
- 🔌 I like understanding systems beneath the UI — database internals, API communication, TCP/IP networking, operating systems, cloud infrastructure, real-time data
- 🏢 Currently on industry placement building the **backend and systems foundation** of a commercial GPS fleet-tracking platform (ShaloTrack)
- 🛡️ Vice Secretary, LNBTI Cybersecurity Club *(previously Treasurer)*
- ✈️ Aviation Club President — long-term goal: fly commercially while building great software

```js
const suwen = {
  role: "Backend & Systems Developer",
  location: "🇱🇰 Sri Lanka",
  currentlyBuilding: "ShaloTrack — GPS Fleet & Asset Tracking Platform",
  stack: ["C#", "ASP.NET Core", "PHP/Laravel", "Kotlin", "PostgreSQL", "TCP/IP"],
  askMeAbout: ["GPS/GT06 protocols", "API architecture", "database design", "aviation ✈️"],
  currentGoal: "🇸🇬 internship / job opportunities in Singapore",
  funFact: "training to fly planes and servers at the same time 🛫",
};
```
...
<details open>
<summary><b>🐍 Contribution Snake</b> — click to collapse</summary>
<br/>
<div align="center">
...
⭐ **ShaloTrack** &nbsp;·&nbsp; ⭐ **Airport Operations Management API** &nbsp;·&nbsp; ⭐ **Medicheks Certificate Verification System**
⭐ **Medicheks Queue Management System** &nbsp;·&nbsp; ⭐ **Sri Lankan JetSpot** &nbsp;·&nbsp; ⭐ **SweTechMart** &nbsp;·&nbsp; ⭐ **EduChat** &nbsp;·&nbsp; ⭐ **PawTawPia**
...
<table>
  ...
  <tr>
    <td valign="top">
      ...
      <img src="https://img.shields.io/badge/x86_Assembly-6E4C13?style=flat-square&logo=assemblyscript&logoColor=white"/>
    </td>
    <td valign="top">
    ...
    <td valign="top">
      <span>✅ REST API Development & DTO Architecture</span><br>
      <span>✅ TCP/IP Socket Programming (GT06 / V5 GPS Protocols)</span><br>
      <span>✅ JWT Authentication & Role-Based Access Control</span><br>
      <span>✅ Relational Database Design & Complex Joins</span><br>
      <span>✅ Middleware & API-Based System Integration</span><br>
      <span>✅ Real-Time GPS Telemetry & Binary Packet Processing</span><br>
      <span>✅ Firebase Cloud Messaging & OTP Workflows</span><br>
      <span>✅ Production Debugging & Root-Cause Analysis</span><br>
      <span>✅ Selenium/TestNG API & Functional Testing</span><br>
...
<table>
  <tr>
    <td valign="top" width="50%">
      <b>🎓 Dean's Award / Dean's List</b><br>
      <i>Lanka Nippon BizTech Institute</i><br>
      Recognised for outstanding academic performance for three consecutive semesters, GPA above 3.8/4.0.
      <br><br>
      <b>🛡️ Cybersecurity Club — LNBTI</b><br>
      • Vice Secretary — 2026/27<br>
      • Treasurer — 2025/26<br>
      Team collaboration, financial documentation, event coordination, organisational leadership.
    </td>
    <td valign="top" width="50%">
      <b>🎖️ Senior Prefect</b><br>
      <i>Yoshida Shokanji International School</i><br>
      Leadership, communication, coordination, decision-making, and organisational skills.
      <br><br>
      <b>✈️ Aviation Club President</b><br>
      Led aviation-related student activities and contributed to an aviation-focused student community.
    </td>
  </tr>
</table>
...
**Lanka Nippon BizTech Institute (LNBTI)** — BSc. (Hons) in Software Engineering
`2023 – 2027` · Maharagama, Sri Lanka · 🏅 Dean's Award — 3 consecutive semesters, GPA above 3.8/4.0

**Yoshida Shokanji International School**
Cambridge International Advanced Level `2021 – 2023` (Mathematics Stream) · Cambridge International Ordinary Level `2011 – 2021`

<details>
<summary><b>📜 Certifications & Professional Learning (click to expand)</b></summary>
<br>

**Microsoft Learn**
Build web apps with ASP.NET Core for beginners · Create a Web API with ASP.NET Core controllers · Introduction to .NET · Build .NET applications with C# · Write your first code using C# · Work with files and directories in a .NET application · Guided Project — Calculate Final GPA · Build web pages with HTML and CSS for beginners

**LinkedIn Learning**
Introducing Postman · Creating API Documentation · AI Coding Agents with GitHub Copilot and Cursor AI · Generative AI for Software Development · Business Ethics · Career Agility in the Age of AI · Software Testing: Tools

**Alison**
Python for Beginners · Introduction to Microservices: Basics to Deployment

**University of Moratuwa**
Python for Beginners — Volume 1

**Cambridge Assessment English**
PET (B1) — ESOL / International English Certification
...
⚙️ Advance ASP.NET Core & API architecture skills &nbsp;·&nbsp; 🗄️ Improve database architecture & optimisation &nbsp;·&nbsp; ☁️ Expand cloud & infrastructure knowledge<br>
🧪 Strengthen testing & QA practices &nbsp;·&nbsp; 🔐 Continue developing cybersecurity knowledge &nbsp;·&nbsp; 🌐 Gain international industry experience<br>
...
<div align="center">
  <a href="mailto:suwencj1@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white"/></a>
  <a href="https://linkedin.com/in/suwen-jayathunga-92525a319/"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white"/></a>
  <a href="https://instagram.com/swen.350"><img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white"/></a>
